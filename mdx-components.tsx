...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    ul: (props) => <ul className="mt-4 list-disc pl-8 font-light" {...props} />,
    code: (props) => (
      <code
        className="relative font-cal rounded bg-muted py-[0.2rem] px-[0.3rem] text-sm font-semibold text-muted-foreground"
        {...props}
      />
    ),
    pre: Codeblock,
